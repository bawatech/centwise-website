              ...
              <div className="bg-black">
                ...
                <div className="relative h-[200px] sm:h-[280px] md:h-[320px] lg:h-[360px] overflow-hidden">
                  {screenshots.map((screen, index) => (
                    ...
                    >
                      {/* REAL IMAGE COMPONENT - Replace placeholder */}
                      <div className="relative w-full h-full">
                        {!imageErrors[screen.id] ? (
                          <>
                            {/* Next.js Image Component for actual screenshots */}
                            <Image
                              src={screen.image}
                              alt={screen.alt}
                              fill
                              className="object-contain" // or "object-cover" based on preference
                            ...
                            />
                            {/* Optional: Add a subtle overlay to make UI elements pop */}
